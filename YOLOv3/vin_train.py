...
from vin_train_dataloader import VINTrainDataset
...
model = DarkNet_53([1, 2, 8, 8, 4], (608, 608)).to(args.device)
...
train_dataset = VINTrainDataset(xtrain, csv, args.image_source)
test_dataset = VINTrainDataset(xtest, csv, args.image_source)
